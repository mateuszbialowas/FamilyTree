...
export const pl = {
  ...
  personDetail: {
    ...
    deceasedNoDate: 'Nie żyje (data nieznana)',
    notesLabel: 'Notatki',
    ...
    marriageLabel: 'Ślub',
    divorceLabel: 'Rozwód',
    marriageNoDate: 'Brak daty ślubu — dotknij ołówka, aby dodać',
    btnEdit: 'Edytuj',
  ...
  addPerson: {
    ...
    coParentTitle: 'Drugi rodzic',
    coParentBodySingle: 'Połącz nowe dziecko również z małżonkiem {{firstName}}:',
    coParentBodyMulti: 'Wybierz drugiego rodzica spośród małżonków {{firstName}}:',
    spouseMarriageTitle: 'Data ślubu',
    spouseMarriageDateLabel: 'Data ślubu (opcjonalne)',
    clearSpouseMarriageDate: 'Wyczyść datę ślubu',
  },
  ...
  editMarriage: {
    title: 'Edytuj małżeństwo',
    notFound: 'Nie znaleziono małżeństwa',
    marriageDateLabel: 'Data ślubu (opcjonalne)',
    divorceDateLabel: 'Data rozwodu (opcjonalne)',
    clearMarriageDate: 'Wyczyść datę ślubu',
    clearDivorceDate: 'Wyczyść datę rozwodu',
    save: 'Zapisz',
    remove: 'Usuń małżeństwo',
    errorDivorceBeforeMarriage: 'Data rozwodu nie może być wcześniejsza niż data ślubu.',
  },
  ...
  history: {
    ...
    actions: {
      ...
      updatedMarriage: 'Zaktualizowano małżeństwo: {{s1}} ⚭ {{s2}}',
